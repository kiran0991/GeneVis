...
#-
#- GeneVis v0.1
#-    Text-based and Parsable application for viewing bam alignments of Gene
#================================================================================================================================
#% SYNOPSIS
#+    ${SCRIPT_NAME} [-help] [-b/-bam=filename] [-f/-fasta=filename] [-d/-bed=filename] [-o/-out=output_directory_path]
#%
#% DESCRIPTION
...
#%
#% EXAMPLES
#%    ${SCRIPT_NAME} -b Chr1.bam -f genome.fasta -c genes.bed -o ./
#%
#================================================================================================================================
#- IMPLEMENTATION
#-    version         ${SCRIPT_NAME} (www.bionivid.com) 0.1.0
...
#-    availibility    GeneVis is available as a standard binary executable. The source code will be available under upon request.
#================================================================================================================================
#- DIPENDANCY
...
awk '{if($0 !~ /^#/){print $1"\t"$2"\t"$3"\t"$4}}' $VCF > Temp.txt
...
do
	...
	#echo "expr $PosEnd - $PosSt"
	
	COLS=`expr $PosEnd - $PosSt`
	COLS=`expr $COLS + 10`
	export COLUMNS=$COLS
	...
	echo "Processing Position $Chr:$PosSt-$PosEnd for $Gene"
	VARPRIME="$Chr-$PosSt-$PosEnd.$Gene.aln.var.txt"
